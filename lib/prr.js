...
function gatherPullRequestCommits(args, cb) {
    ...
    gitClient.get(
        format(
            '/repos/%s/pulls/%s/commits?per_page=100',
            args.gitRepo,
            args.prNumber
        ),
...
function gatherReviewerUsernames(args, cb) {
    ...
    gitClient.get(
        format(
            '/repos/%s/pulls/%s/reviews?per_page=100',
            args.gitRepo,
            args.prNumber
        ),
...
function gatherApproverUsername(args, cb) {
    ...
    gitClient.get(
        format(
            '/repos/%s/issues/%s/events?per_page=100',
            args.gitRepo,
            args.prNumber
        ),
...
function getAnswer(args, cb) {
    ...
    var filesLink = format(
        'https://github.com/%s/pull/%s/files',
        args.gitRepo,
        args.prNumber
    );
